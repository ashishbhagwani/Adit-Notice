...
public class Question17 extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        counter.setText("17 out of 19 Questions");
        question.setText(R.string.question17);
        option1.setText(R.string.difficult);
        option2.setText(R.string.average);
        option3.setText(R.string.liberal);
        if(response.getallresponses().get(17)!=null){
            options.check(response.getResponseId(17));
        }
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!(options.getCheckedRadioButtonId()==-1)){
                    ...
                    response.addresponse(17,viewid,selectedoption);
