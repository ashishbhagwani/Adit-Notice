...
public class Question3 extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(arguments.get("type").toString().equals("theory")) {
            counter.setText("3 out of 19 Questions");
            ...
            counter.setText("3 out of 10 Questions");
            question.setText(R.string.pquestion3);
            option1.setText(R.string.always);
            option2.setText(R.string.often);
            option3.setText(R.string.rarley);
        }
        if(response.getallresponses().get(3)!=null){
            options.check(response.getResponseId(3));
        }
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!(options.getCheckedRadioButtonId()==-1)){
                    ...
                    response.addresponse(3, viewid, selectedoption);
