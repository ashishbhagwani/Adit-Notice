...
public class Question15 extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        counter.setText("15 out of 19 Questions");
        question.setText(R.string.question15);
        option1.setText(R.string.closely);
        option2.setText(R.string.marginally);
        option3.setText(R.string.poorly);
        if(response.getallresponses().get(15)!=null){
            options.check(response.getResponseId(15));
        }
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!(options.getCheckedRadioButtonId()==-1)){
                    ...
                    Fragment fragment = new Question16();
                    ...
                    response.addresponse(15,viewid,selectedoption);
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Fragment fragment = new Question14();
                fragment.setArguments(arguments);
                ftransaction.replace(R.id.framelayout, fragment);
                ftransaction.commit();
            }
