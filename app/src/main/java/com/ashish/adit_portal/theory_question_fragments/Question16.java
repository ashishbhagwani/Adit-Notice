...
public class Question16 extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        counter.setText("16 out of 19 Questions");
        question.setText(R.string.question16);
        option1.setText(R.string.thourougly);
        option2.setText(R.string.marginally);
        option3.setText(R.string.hardly);
        if(response.getallresponses().get(16)!=null){
            options.check(response.getResponseId(16));
        }
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!(options.getCheckedRadioButtonId()==-1)){
                    ...
                    Fragment fragment = new Question17();
                    ...
                    response.addresponse(16,viewid,selectedoption);
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Fragment fragment = new Question15();
                fragment.setArguments(arguments);
                ftransaction.replace(R.id.framelayout, fragment);
                ftransaction.commit();
            }
