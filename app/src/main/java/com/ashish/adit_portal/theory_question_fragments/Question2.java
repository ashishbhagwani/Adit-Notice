...
public class Question2 extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(arguments.get("type").toString().equals("theory")) {
            counter.setText("2 out of 19 Questions");
            ...
            if(response.getallresponses().get(2)!=null){
                options.check(response.getResponseId(2));
            }
        }else{
            counter.setText("2 out of 10 Questions");
            question.setText(R.string.pquestion2);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!(options.getCheckedRadioButtonId()==-1)){
                    ...
                    response.addresponse(2, viewid, selectedoption);
