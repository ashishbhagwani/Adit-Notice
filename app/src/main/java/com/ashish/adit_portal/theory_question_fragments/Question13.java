...
public class Question13 extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        counter.setText("13 out of 19 Questions");
        question.setText(R.string.question13);
        option1.setText(R.string.Excellent);
        option2.setText(R.string.average);
        option3.setText(R.string.poor);
        if(response.getallresponses().get(13)!=null){
            options.check(response.getResponseId(13));
        }
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!(options.getCheckedRadioButtonId()==-1)){
                    ...
                    response.addresponse(13,viewid,selectedoption);
