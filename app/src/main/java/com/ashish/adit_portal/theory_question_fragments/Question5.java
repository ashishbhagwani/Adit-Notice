...
public class Question5 extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(arguments.get("type").toString().equals("theory")) {
            counter.setText("5 out of 19 Questions");
            question.setText(R.string.question5);
            option1.setText(R.string.yes);
            option2.setText(R.string.no);
            option3.setVisibility(View.INVISIBLE);
        }else{
            counter.setText("5 out of 10 Questions");
            question.setText(R.string.pquestion5);
            option1.setText(R.string.often);
            option2.setText(R.string.sometimes);
            option3.setText(R.string.rarley);
        }
        if (response.getallresponses().get(5) != null) {
            options.check(response.getResponseId(5));
        }
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!(options.getCheckedRadioButtonId()==-1)){
                    ...
                    Fragment fragment = new Question6();
                    ...
                    response.addresponse(5, viewid, selectedoption);
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Fragment fragment = new Question4();
                fragment.setArguments(arguments);
                ftransaction.replace(R.id.framelayout, fragment);
                ftransaction.commit();
            }
