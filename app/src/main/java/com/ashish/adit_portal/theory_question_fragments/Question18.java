...
public class Question18 extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        counter.setText("18 out of 19 Questions");
        question.setText(R.string.question18);
        option1.setText(R.string.always);
        option2.setText(R.string.often);
        option3.setText(R.string.rarley);
        if(response.getallresponses().get(18)!=null){
            options.check(response.getResponseId(18));
        }
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!(options.getCheckedRadioButtonId()==-1)){
                    ...
                    Fragment fragment = new Question19();
                    ...
                    response.addresponse(18,viewid,selectedoption);
