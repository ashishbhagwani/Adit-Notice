...
public class Question14 extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        counter.setText("14 out of 19 Questions");
        question.setText(R.string.question14);
        option1.setText(R.string.outstanding);
        option2.setText(R.string.average);
        option3.setText(R.string.poor);
        if(response.getallresponses().get(14)!=null){
            options.check(response.getResponseId(14));
        }
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!(options.getCheckedRadioButtonId()==-1)){
                    ...
                    response.addresponse(14,viewid,selectedoption);
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Fragment fragment = new Question13();
                fragment.setArguments(arguments);
                ftransaction.replace(R.id.framelayout, fragment);
                ftransaction.commit();
            }
