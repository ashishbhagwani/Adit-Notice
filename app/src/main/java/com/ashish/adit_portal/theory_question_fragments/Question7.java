...
public class Question7 extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(arguments.get("type").toString().equals("theory")) {
            counter.setText("7 out of 19 Questions");
            ...
            counter.setText("7 out of 10 Questions");
            question.setText(R.string.pquestion7);
            option1.setText(R.string.often);
            option2.setText(R.string.sometimes);
            option3.setText(R.string.rarley);
        }
        if (response.getallresponses().get(7) != null) {
            options.check(response.getResponseId(7));
        }
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!(options.getCheckedRadioButtonId()==-1)){
                    ...
                    Fragment fragment = new Question8();
                    ...
                    response.addresponse(7, viewid, selectedoption);
