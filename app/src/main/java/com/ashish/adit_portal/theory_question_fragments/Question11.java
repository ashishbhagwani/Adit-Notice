...
public class Question11 extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        counter.setText("11 out of 19 Questions");
        question.setText(R.string.question11);
        option1.setText(R.string.clear);
        option2.setText(R.string.partially_understandable);
        option3.setText(R.string.vague);
        if (response.getallresponses().get(11) != null) {
            options.check(response.getResponseId(11));
        }
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!(options.getCheckedRadioButtonId()==-1)){
                    ...
                    Fragment fragment = new Question12();
                    ...
                    response.addresponse(11,viewid,selectedoption);
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Fragment fragment = new Question10();
                fragment.setArguments(arguments);
                ftransaction.replace(R.id.framelayout, fragment);
                ftransaction.commit();
            }
