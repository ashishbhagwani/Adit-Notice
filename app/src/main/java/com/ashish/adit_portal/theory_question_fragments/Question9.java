...
public class Question9 extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(arguments.get("type").toString().equals("theory")) {
            counter.setText("9 out of 19 Questions");
            ...
            counter.setText("9 out of 10 Questions");
            question.setText(R.string.pquestion9);
            option1.setText(R.string.Excellent);
            option2.setText(R.string.average);
            option3.setText(R.string.poor);

        }
        if (response.getallresponses().get(9) != null) {
            options.check(response.getResponseId(9));
        }
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!(options.getCheckedRadioButtonId()==-1)){
                    ...
                    response.addresponse(9, viewid, selectedoption);
